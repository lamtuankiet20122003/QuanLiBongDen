...
public class viewqlnhapkho extends JFrame {
	...
	public static void main(String[] args ) {
		...
		viewqlnhapkho frame=new viewqlnhapkho(nguoidung);
		frame.setVisible(true);
	}
	public viewqlnhapkho(User nguoidung) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(viewqlnhapkho.class.getResource("/Hinhanh/bulb_icon.png")));
		...
		JLabel lblNewLabel = new JLabel("CHÀO MỪNG QUẢN LÍ NHẬP KHO");
		...
		mntmNewMenuItem.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/logout.png")));
		...
		mntmNewMenuItem_3.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/user-info-icon.png")));
		...
		mntmNewMenuItem_2.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/change_pass_icon.png")));
		...
		JMenuItem mntmNewMenuItem_1 = new JMenuItem("Lịch sử nhập kho");
		mntmNewMenuItem_1.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/history_icon.png")));
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				closeviewqlnhapkho();
				Viewlichsunhaphang viewlichsunhaphang=new Viewlichsunhaphang(nguoidung);
				viewlichsunhaphang.showviewlichsunhaphang();
				
			}
		});
		
		JMenuItem mntmNewMenuItem_1_1 = new JMenuItem("Kho hàng");
		mntmNewMenuItem_1_1.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/storage_icon.png")));
		...
		btnNewButton.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/import_icon (1).png")));
		...
		btnNewButton.setBounds(337, 139, 200, 35);
		contentPane.add(btnNewButton);
		
		JButton btnXemThngTin = new JButton("  Làm mới");
		btnXemThngTin.setHorizontalAlignment(SwingConstants.LEFT);
		btnXemThngTin.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/refresh_icon.png")));
		...
		btnXemThngTin.setBackground(new Color(255, 0, 0));
		btnXemThngTin.setBounds(337, 256, 200, 35);
		...
		box_sort.setBounds(263, 382, 244, 35);
		...
		but_sort_tang.setBounds(262, 426, 121, 44);
		...
		but_sort_giam.setBounds(386, 426, 121, 44);
		...
		JButton btnThmBngFile = new JButton("Thêm bằng file Excel");
		btnThmBngFile.setHorizontalAlignment(SwingConstants.LEFT);
		btnThmBngFile.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/import_excel_icon(1).png")));
		btnThmBngFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				chucnang.addsp_byexcel(nguoidung.getManv());
			}
		});
		btnThmBngFile.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnThmBngFile.setBackground(new Color(0, 255, 255));
		btnThmBngFile.setBounds(337, 179, 200, 35);
		contentPane.add(btnThmBngFile);
		
		JButton btnInRaFile = new JButton("In ra file Excel");
		btnInRaFile.setHorizontalAlignment(SwingConstants.LEFT);
		btnInRaFile.setIcon(new ImageIcon(viewqlnhapkho.class.getResource("/Hinhanh/print-excel-icon (1).png")));
		...
		btnInRaFile.setBackground(new Color(255, 255, 0));
		btnInRaFile.setBounds(337, 216, 200, 35);
		contentPane.add(btnInRaFile);
	}
	public void showviewqlnhapkho() {
		this.setVisible(true);
	}
	public void closeviewqlnhapkho() {
